...
import com.shunhaoluo.Utils.DisplayUtil;
import com.shunhaoluo.Bean.InfoData;
...
public class IOSWeatherInfoView extends View {
    ...
    private static final String LOG_TAG = IOSWeatherInfoView.class.getSimpleName();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int cityHeight = (int)(mHeight*(0.15 + (1-progress)*0.55));
        ...
        //temperatures
        float alphaProgress = progress*2-1.0f;
...
//        Log.i("TAG" , progress + "");
        mPaint.setAlpha((int)(255*alphaProgress));
